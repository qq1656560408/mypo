...
public class RenewablePhyQuantityExcel extends BaseExcelDataProcessing {
	...
	List<RenewablePhyQuantityTable> renewablePhyQuantityTables = new ArrayList<>();
	...
	public List<RenewablePhyQuantityTable> getRenewablePhyQuantityTables() {
		return renewablePhyQuantityTables;
	}

	public void setRenewablePhyQuantityTables(List<RenewablePhyQuantityTable> renewablePhyQuantityTables) {
		this.renewablePhyQuantityTables = renewablePhyQuantityTables;
	}

	public RenewablePhyQuantityExcel(IWaterTypeandFeaturesTableService typeAndFeaturesService,
			InitBaseData initBaseData) {
	...
	public void setParam(int yearID, int typeID, String features, String areaName, int cellIndex, Workbook wookbook,
		...
		RenewablePhyQuantityTable renewablePhyQuantityTable = new RenewablePhyQuantityTable();
		renewablePhyQuantityTable.setTypeAndFeaturesID(waterTypeandFeaturesTable.getWaterTypeAndFeaturesID());
		renewablePhyQuantityTable.setInventory(value);
		renewablePhyQuantityTable.setInventoryUnit(utilStr);
		renewablePhyQuantityTable.setRemark(remarkStr);

		renewablePhyQuantityTables.add(renewablePhyQuantityTable);
	}
