...
public class LandPriceExcel extends BaseExcelDataProcessing {
	...
	public LandPriceExcel(IWaterTypeandFeaturesTableService typeAndFeaturesService, InitBaseData initBaseData) {
	...
	List<LandPriceTable> landPriceTables = new ArrayList<>();

	public List<LandPriceTable> getLandPriceTables() {
		return landPriceTables;
	}

	public void setLandPriceTables(List<LandPriceTable> landPriceTables) {
		this.landPriceTables = landPriceTables;
	}
	...
	public void setParam(int yearID, int typeID, String features, String areaName, int cellIndex, Workbook wookbook,
		...
		// 价格表参数
		LandPriceTable land = new LandPriceTable();
		land.setTypeAndFeaturesID(waterTypeandFeaturesTable.getWaterTypeAndFeaturesID());
		land.setPrice(value);
		land.setUnit(utilStr);
		land.setRemark(remarkStr);
		land.setCoefficient(coefficientDou);
		landPriceTables.add(land);
