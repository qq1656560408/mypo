...
public class AtmospherePriceExcel extends BaseExcelDataProcessing {
	...
	List<AtmospherePriceTable> atmospherePriceTables = new ArrayList<>();

	public List<AtmospherePriceTable> getAtmospherePriceTables() {
		return atmospherePriceTables;
	}

	public void setAtmospherePriceTables(List<AtmospherePriceTable> atmospherePriceTables) {
		this.atmospherePriceTables = atmospherePriceTables;
	}
	

	public AtmospherePriceExcel(IWaterTypeandFeaturesTableService typeAndFeaturesService, InitBaseData initBaseData) {
	...
	public void setParam(int yearID, int typeID, String features, String areaName, int cellIndex, Workbook wookbook,
		...
		// 价格表参数
		AtmospherePriceTable atmospherePriceTable = new AtmospherePriceTable();
		atmospherePriceTable.setTypeAndFeaturesID(waterTypeandFeaturesTable.getWaterTypeAndFeaturesID());
		atmospherePriceTable.setPrice(value);
		atmospherePriceTable.setUnit(utilStr);
		atmospherePriceTable.setRemark(remarkStr);
		atmospherePriceTable.setCoefficient(coefficientDou);
		atmospherePriceTables.add(atmospherePriceTable);
