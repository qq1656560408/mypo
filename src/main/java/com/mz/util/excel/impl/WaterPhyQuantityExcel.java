...
public class WaterPhyQuantityExcel extends BaseExcelDataProcessing {
	...
	List<WaterPhyQuantityTable> waterPhyQuantityTables = new ArrayList<>();
	...
	public List<WaterPhyQuantityTable> getWaterPhyQuantityTables() {
		return waterPhyQuantityTables;
	}

	public void setWaterPhyQuantityTables(List<WaterPhyQuantityTable> waterPhyQuantityTables) {
		this.waterPhyQuantityTables = waterPhyQuantityTables;
	}

	public WaterPhyQuantityExcel(IWaterTypeandFeaturesTableService typeAndFeaturesService, InitBaseData initBaseData) {
	...
	public void setParam(int yearID, int typeID, String features, String areaName, int cellIndex, Workbook wookbook,
		...
		WaterPhyQuantityTable waterPhyQuantityTable = new WaterPhyQuantityTable();
		waterPhyQuantityTable.setWaterTypeAndFeaturesID(waterTypeandFeaturesTable.getWaterTypeAndFeaturesID());
		waterPhyQuantityTable.setInventory(value);
		waterPhyQuantityTable.setInventoryUnit(utilStr);
		waterPhyQuantityTable.setRemark(remarkStr);

		waterPhyQuantityTables.add(waterPhyQuantityTable);
	}
