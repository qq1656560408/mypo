    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                ...
                var tleft = $(this).offset().left-238;    //控件的定位点宽
                $("#colorpanel").css({
                    top:ttop+thei+5,
                    left:tleft
                }).show();
        ...
        function initColor(){
            ...
            +'<tr><td width="3"><td style="width: 70px;height: 17px"><input type="text" id="DisColor" size="6" disabled style="border:solid 1px #000000;background-color:#ffff00;width:58px;margin-top:10px;height:17px"></td>'
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;margin-top: 13px;width: 59px;height: 17px" value="#000000"><a href="javascript:void(0);" id="_cclose" style="margin-left: -11px">关闭</a> | <a href="javascript:void(0);" id="_creset">清除</a></td></tr></table></td></table>'
