 ...
 */
          $("#outerContainer").css("height",$("#body").height());
...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '../web/pdfjs-1.9.426-dist/build/pdf.worker.js';
...
var DEFAULT_URL = '../web/upload/梅州市党政领导干部自然资源资产离任审计系统标准说明.pdf';
;
