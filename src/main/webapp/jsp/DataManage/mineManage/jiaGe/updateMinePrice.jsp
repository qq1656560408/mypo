...
<body>
	...
	<input id="waterPriceID" name="waterPriceID" type="hidden" value="${swp.minePriceID}">
		<div class="layui-form-item">
			<div class="layui-inline">
				<label class="layui-form-label">年份</label>
				<div class="layui-input-inline">
					<input type="text" name="year" class="layui-input" id="yearMC" value="${swp.yearMC}" readonly="readonly">
				</div> 
			</div>
			<div class="layui-inline">
	...
	<script type="text/javascript">
		...
		layui.use('form', function() {
			...
			form.on('submit(*)', function(getData) {
				...
				$.ajax({
					url : "${path}/minePriceTable/updatePrice.do",
					data : data,
					dataType : "json",
					type : "post",
