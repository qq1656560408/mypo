...
<body>
	<form class="layui-form" style="padding: 10px;" >
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="year" class="layui-input" id="mineYear">
				</div>
			</div>
			<div class="layui-inline">
		...
		<div class="layui-form-item">
			<div class="layui-input-block">
				<button class="layui-btn" lay-submit lay-filter="mineSub">立即提交</button>
			</div>
		</div>
	</form>
	<script type="text/javascript">
		...
		layui.use('form', function() {
			...
			form.on('submit(mineSub)', function(getData) {
				var data = getData.field; //当前容器的全部表单字段，名值对形式：{name: value}
				$.ajax({
					url : "${path}/minePriceTable/insertPrice.do",
					data : data,
					dataType : "json",
					type : "post",
