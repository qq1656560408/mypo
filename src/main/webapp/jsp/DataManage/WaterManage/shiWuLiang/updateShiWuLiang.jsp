...
<body>
	...
	<input name="waterPhyQuantityID" type="hidden" value="${spq.waterPhyQuantityID}">
		<div class="layui-form-item">
			<div class="layui-inline">
				<label class="layui-form-label">年份</label>
				<div class="layui-input-inline">
					<input type="text" name="year" class="layui-input" value="${spq.yearMC}">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label">类别</label>
				<div class="layui-input-inline">
				  <input type="text" name="waterTypeMC" class="layui-input" value="${spq.waterTypeMC}"readonly="readonly">
				</div>
			</div>
		</div>
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
				    <input type="text" name="waterFeatures" value="${spq.waterFeatures}" class="layui-input" readonly="readonly">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label">区县</label>
				<div class="layui-input-inline">
				 <input type="text" name="areaMC" value="${spq.areaMC}" class="layui-input" readonly="readonly">
		...
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="inventoryUnit" autocomplete="off" class="layui-input" value="${spq.inventoryUnit}">
				</div>
			</div>
		</div>
		<div class="layui-form-item">
	...
	<script type="text/javascript">
		...
		layui.use('form', function() {
			...
			form.on('submit(*)', function(getData) {
				...
				$.ajax({
					url : "${path}/waterPhyQuantityTable/updatePhyQuantity.do",
					data : data,
					dataType : "json",
					type : "post",
