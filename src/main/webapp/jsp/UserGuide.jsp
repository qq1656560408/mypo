...
<link rel="stylesheet" href="${pathweb}/content/css/UserGuide.css">
...
<div id="top">
	...
	<ul id="top_menu">
		...
		<li title="用户指南" class="menu_hover_bg"><a href="javascript:void(0)"><img alt="图片" src="${pathweb}/content/images/aliicons/companion.png" /><span>用户指南</span></a></li>
	</ul>
</div>
<div id="body">
...
<script src="${pathweb}/content/js/UserGuide.js" charset="utf-8"></script>
</body>
</html>