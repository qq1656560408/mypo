...
<form class="layui-form layui-form-pane" action="">
  <div id="layui-form-type" class="layui-form-item">
      <div class="layui-input-inline">
        <select lay-filter="sel_examine" name="sel_examine">
           <option value="-1">全部</option>
           <option value="0">待考核</option>
           <option value="1">已考核</option>
        </select>
      </div>
  </div>
</form>
	<table id="tab_Audtiting" class="layui-table" lay-skin="line">
		...
		<tbody id="tab_tbody">
			<tr><td>1</td><td>1</td><td>1</td><td><div class="site-demo-button" id="layerDemo" style="margin-bottom: 0;">
	...
	<script type="text/javascript" src="${pathweb}/content/js/ResignAudit/SubmissionOfRecords.js" charset="utf-8"></script>
</body>
</html>